...
VL_MODULE(Vtop) {
  public:
    ...
    VL_SIG8(top__DOT__num_carros,3,0);
    VL_SIG8(top__DOT__cancela_entrada,1,0);
    VL_SIG8(top__DOT__cancela_saida,0,0);
    VL_SIG8(top__DOT__estado_atual,3,0);
    VL_SIG8(top__DOT__clk_1,0,0);
